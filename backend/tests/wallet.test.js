    ...
    describe('createTransaction()', () => {
        ...
        describe('and a chain is passed', () => {
            it('calls `Wallet.calculateBalance`', () => {
                ...
                const originalCalcualteBalance = Wallet.calculateBalance;
                ...
                Wallet.calculateBalance = originalCalcualteBalance;
            });
        });
    });
        ...
        describe('and there are outputs for the wallet', () => {
            ...
            describe('and the wallet has made a transaction', () => {
                ...
                describe('and there are outputs next to and after the recent transaction', () => {
                    let sameBlockTransaction, nextBlockTransacton;
                    ...
                    beforeEach(() => {
                        ...
                        nextBlockTransacton = new Wallet().createTransaction({
                            recipient: wallet.publicKey, amount: 75
                        });
                        blockchain.addBlock({ data: [nextBlockTransacton] });
                    });
                    ...
                    it('includes the output amounts in the returned balance', () => {
                        expect(
                            ...
                            nextBlockTransacton.outputMap[wallet.publicKey]
                        )
                    });
                });
            });
